    ...
    try {
      ...
      const mockFinancialStatement: FinancialStatement = {
        ...
        cashFlowStatement: {
          ...
          capitalExpendituresPercent: 10.0,
      ...
      const financialData: FinancialData = {
        ...
        marketCap: mockCompanyInfo.marketCap,
        stockPrice: mockCompanyInfo.marketCap / mockFinancialStatement.incomeStatement.sharesOutstanding
      };
